...
public abstract class AppWorkspaceComponent {
    ...
    public abstract void selectedItemProps(AppDataComponent dataComponent);
    ...
    public abstract void updateLists(AppDataComponent dataComponent);
    
    public abstract void updateCanvas(AppDataComponent data);
}
