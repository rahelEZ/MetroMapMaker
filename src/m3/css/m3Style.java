...
public class m3Style {
    ...
    public static final String LEFT_SIDE_WELCOME = "left_side_welcome";
    public static final String RIGHT_SIDE_WELCOME = "left_side_welcome";
    public static final String CONFIDENT_ELEMENT = "confident_element";
}
