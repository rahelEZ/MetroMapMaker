...
/**
 *
 * @author McKillaGorilla + Rahel Zewde
 */
public class jTPS {
    ...
    public jTPS(PostTransaction postTransaction) {
        this.postTransaction = postTransaction;
    }
    
    
    public void addTransaction(jTPS_Transaction transaction, boolean actuallyDo) {
    ...
    public void doTransaction(boolean real) {
        if (mostRecentTransaction < (transactions.size()-1)) {
            ...
            transaction.doTransaction();
                ...
                System.err.println("fake call");
            }
            mostRecentTransaction++;
        }
        
        postTransaction.run(canRedo(), canUndo());
    }
